Rails.application.routes.draw do
  ...
  post '/device/chown', to: 'devices#chown'
  ...
  get '/user/su' => 'users#su'
  get '/user/modals/su' => 'users#modal_su'
  get '/user/modals/delete' => 'users#modal_delete'
  get '/user/modals/update' => 'users#modal_update'
  get '/user/modals/new' => 'users#modal_new'
  ...
  post '/media/delete'  => 'uploads#destroy'
  get 'songs/:user_id/:file.:ext' => 'uploads#songs'
